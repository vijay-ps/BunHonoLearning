    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="border-indigo-200 dark:border-indigo-800 glass dark:glass-dark">
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="p-3 bg-indigo-50 dark:bg-indigo-900/40 rounded-md border border-indigo-100 dark:border-indigo-800">
              ...
              <Button
                variant="outline"
                className="w-full border-indigo-200 dark:border-indigo-800 text-indigo-700 dark:text-indigo-300 hover:bg-indigo-50 dark:hover:bg-indigo-900/20"
              >
