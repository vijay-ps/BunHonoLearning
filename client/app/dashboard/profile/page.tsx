    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-1">
          <Card className="border-indigo-200 dark:border-indigo-800 glass dark:glass-dark">
              ...
              <div className="flex flex-col items-center">
                <Avatar className="h-24 w-24 mb-4">
                  <AvatarImage
                    ...
                    alt={user.name}
                  />
                  <AvatarFallback className="bg-indigo-100 dark:bg-indigo-900/50 text-indigo-700 dark:text-indigo-300 text-xl">
                    {user.name
                      .split(" ")
                      .map((n) => n[0])
                      .join("")
        ...
        <div className="md:col-span-2">
          ...
          <Card className="border-indigo-200 dark:border-indigo-800 glass dark:glass-dark mt-6">
            <CardHeader>
              <CardTitle className="text-indigo-700 dark:text-indigo-400">
                Recent Activity
              </CardTitle>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex">
                  <div className="mr-4 flex h-10 w-10 items-center justify-center rounded-full bg-indigo-100 dark:bg-indigo-900/40">
                ...
                <div className="flex">
                  <div className="mr-4 flex h-10 w-10 items-center justify-center rounded-full bg-indigo-100 dark:bg-indigo-900/40">
                    <Shield className="h-5 w-5 text-indigo-700 dark:text-indigo-400" />
                  </div>
                  <div>
