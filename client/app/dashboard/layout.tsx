...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 to-white dark:from-slate-950 dark:to-slate-900 flex flex-col transition-colors duration-300">
      <header className="border-b border-indigo-100 dark:border-indigo-800 bg-white dark:bg-slate-950/50 sticky top-0 z-10 backdrop-blur-md">
      ...
      <footer className="border-t border-indigo-100 dark:border-indigo-800 bg-white dark:bg-slate-950/50 py-4 backdrop-blur-md">
